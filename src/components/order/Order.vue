  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="订单编号" min-width="150" prop="order_number"></el-table-column>
    ...
    <el-dialog title="修改地址" :visible.sync="addresVisible" width="50%" @close="addressDialogClosed">
      <el-form :model="addredForm" :rules="addredFormRules" ref="addredFormRef" label-width="100px">
        <el-form-item label="省市区/县" prop="addres1">
          <el-cascader :options="cityData" v-model="addredForm.address1"></el-cascader>
        </el-form-item>
        <el-form-item label="详细地址" prop="addres2">
          <el-input v-model="addredForm.addres2"></el-input>
        </el-form-item>
      </el-form>
